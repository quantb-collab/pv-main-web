...
// Hand-edited: h-8/rounded-lg/px-2.5 -> --h-control-md/rounded-control/px-3 to match the
// shared control scale. `shadcn add input` overwrites this — reapply.
